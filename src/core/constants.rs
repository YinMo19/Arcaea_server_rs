...
pub const CORE_DATABASE_PATH: &str = Config::CORE_DATABASE_PATH;
pub const CORE_DATABASE_DELETED_PATH: &str = Config::CORE_DATABASE_DELETED_PATH;

pub const USER_DATABASE_PATH: &str = Config::USER_DATABASE_PATH;
pub const USER_DATABASE_DELETED_PATH: &str = Config::USER_DATABASE_DELETED_PATH;
